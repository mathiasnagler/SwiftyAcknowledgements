...
open class AcknowledgementsTableViewController: UITableViewController {
  ...
  @IBInspectable open var headerFontSize: CGFloat = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .subheadline).pointSize {
        didSet {
            tableView.tableHeaderView = newTableHeaderView
        }
    }
  ...
  @IBInspectable open var footerFontSize: CGFloat = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .subheadline).pointSize {
        didSet {
  ...
  @IBInspectable open var detailFontSize: CGFloat = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body).pointSize
    ...
    open override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = acknowledgements[(indexPath as NSIndexPath).row].title
    ...
    open override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let detailViewController = AcknowledgementViewController(acknowledgement: acknowledgements[(indexPath as NSIndexPath).row])
